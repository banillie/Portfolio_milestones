'''This programme returns an excel wb with a print out of all project reported milestones (ideally between a set
time peiod) and any movement in dates in comparison to last quarter and one year ago (and or latest baseline for
project)
...
the programme should return e.g. 'project' 'approval' 'assurance'. Hash out the list according to need'''

all_milestone_keys = ['Approval MM1', 'Approval MM2', 'Approval MM3', 'Approval MM4', 'Approval MM5', 'Approval MM6',
                  ...
                  'Project MM32', 'Assurance MM1', 'Assurance MM2', 'Assurance MM3', 'Assurance MM4', 'Assurance MM5',
                  'Assurance MM6', 'Assurance MM7', 'Assurance MM8', 'Assurance MM9', 'Assurance MM10',
                  'Assurance MM11', 'Assurance MM12', 'Assurance MM13', 'Assurance MM14', 'Assurance MM15',
                  'Assurance MM16', 'Assurance MM17', 'Assurance MM18']
all_milestone_dates = ['Approval MM1 Forecast / Actual', 'Approval MM2 Forecast / Actual', 'Approval MM3 Forecast / Actual',
                   ...
                   'Project MM31 Forecast - Actual', 'Project MM32 Forecast - Actual','Assurance MM1 Forecast - Actual',
                   'Assurance MM2 Forecast - Actual', 'Assurance MM3 Forecast - Actual',
                   'Assurance MM4 Forecast - Actual', 'Assurance MM5 Forecast - Actual',
                   'Assurance MM6 Forecast - Actual', 'Assurance MM7 Forecast - Actual',
                   'Assurance MM8 Forecast - Actual', 'Assurance MM9 Forecast - Actual',
                   'Assurance MM10 Forecast - Actual', 'Assurance MM11 Forecast - Actual',
                   'Assurance MM12 Forecast - Actual', 'Assurance MM13 Forecast - Actual',
                   'Assurance MM14 Forecast - Actual', 'Assurance MM15 Forecast - Actual',
...
a_p_milestone_keys = ['Approval MM1', 'Approval MM2', 'Approval MM3', 'Approval MM4', 'Approval MM5', 'Approval MM6',
                  'Approval MM7', 'Approval MM8', 'Approval MM9', 'Approval MM10', 'Approval MM11', 'Approval MM12',
                  'Approval MM13', 'Approval MM14', 'Approval MM15', 'Approval MM16', 'Project MM18', 'Project MM19',
                  'Project MM20', 'Project MM21', 'Project MM22', 'Project MM23', 'Project MM24', 'Project MM25',
                  'Project MM26', 'Project MM27', 'Project MM28', 'Project MM29', 'Project MM30', 'Project MM31',
                  'Project MM32']
a_p_milestone_dates = ['Approval MM1 Forecast / Actual', 'Approval MM2 Forecast / Actual',
                       'Approval MM3 Forecast / Actual',
                       'Approval MM4 Forecast / Actual', 'Approval MM5 Forecast / Actual',
                       'Approval MM6 Forecast / Actual','Approval MM7 Forecast / Actual',
                       'Approval MM8 Forecast / Actual', 'Approval MM9 Forecast / Actual',
                       'Approval MM10 Forecast / Actual', 'Approval MM11 Forecast / Actual',
                       'Approval MM12 Forecast / Actual', 'Approval MM13 Forecast - Actual',
                       'Approval MM14 Forecast - Actual', 'Approval MM15 Forecast - Actual',
                       'Approval MM16 Forecast - Actual', 'Project MM18 Forecast - Actual',
                       'Project MM19 Forecast - Actual', 'Project MM20 Forecast - Actual',
                       'Project MM21 Forecast - Actual', 'Project MM22 Forecast - Actual',
                       'Project MM23 Forecast - Actual', 'Project MM24 Forecast - Actual',
                       'Project MM25 Forecast - Actual', 'Project MM26 Forecast - Actual',
                       'Project MM27 Forecast - Actual', 'Project MM28 Forecast - Actual',
                       'Project MM29 Forecast - Actual', 'Project MM30 Forecast - Actual',
                       'Project MM31 Forecast - Actual', 'Project MM32 Forecast - Actual']

'''business case approval milestones'''
bc_milestone_keys = ['Approval MM1', 'Approval MM3', 'Approval MM10']
...
def project_milestones_dict(proj_name, data, m_list_keys, m_list_dates):
    ...
    if proj_name in data.keys():
        m_dict = {}
        proj_data = data[proj_name]
        '''m_list is a list of milestone keys. The below loop puts specific project milestone keys into a list'''
        milestone_keys = []
        for key in m_list_keys:
        ...
        for date in m_list_dates:
            reported_date = proj_data[date]
            milestone_dates.append(reported_date)
        ...
        for i in range(0, len(milestone_keys)):
            ...
            '''handles none type reporting for milestone dates. These are not needed in dictionaries'''
...
'''Function that filters milestones between the range of interest and calculates the time delta difference between 
...
def run_standard_comparator(proj_list, dict_1, dict_2, dict_3, milestone_keys, milestone_dates):
    wb = Workbook()
    ws = wb.active
    ...
    for x in proj_list:
        current_milestones = project_milestones_dict(x, dict_1, milestone_keys, milestone_dates)
        current_milestones_dict[x] = current_milestones
        last_milestones = project_milestones_dict(x, dict_2, milestone_keys, milestone_dates)
        last_milestones_dict[x] = last_milestones
        oldest_milestones = project_milestones_dict(x, dict_3, milestone_keys, milestone_dates)
